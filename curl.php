...
$url3 = "http://www.228365365.com/app/member/FT_future/body_var.php?uid=test00&rtype=r&langx=zh-cn&mtype=3&page_no=".$k."&league_id=&hot_game=";
...
$page = explode("page=", $pageContent1); //拆 資料頁
$comma = strpos($page[1],";"); //抓數字後的逗號位子
$pageNumber = substr( $page[1] , 0, $comma); //取出總共頁面數字
